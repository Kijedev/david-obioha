...
export default function page() {
    return (
        <main className="bg-white">
            ...
            <header className="lg:h-screen h-[60vh] flex flex-col justify-center px-4 sm:px-6 md:px-10 lg:px-20 pt-10 text-white overflow-hidden">
                ...
                <p className="text-lg text-[#101828]/80 text-center mt-6 sm:mt-8 max-w-2xl mx-auto">
                ...
                <div className="flex items-center justify-center gap-4 sm:gap-6 mt-6 sm:mt-8 text-[#101828]">
